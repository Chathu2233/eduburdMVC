...
INSERT INTO `assignment` (`assignment_id`, `grade_class_id`, `title`, `description`, `file`) VALUES
(3, NULL, 'farshad', 'gombettah\r\nthadiya\r\nhotu kolla', 0x75706c6f6164732f323032312d47726164652d30382d4d617468732d54686972642d5465726d2d50617065722d576974682d416e73776572732d5765737465726e2d50726f76696e63652d70616765732d64656c657465642e706466);
...
(1, '', 'aa', 'aa', 'ss@gmail.com', '0000-00-00', '$2y$10', 1111),
...
--
ALTER TABLE `assignment_submission`
  MODIFY `assignment_submission_id` int(10) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `course_grade`
  MODIFY `course_grade_id` int(10) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tutor`
  MODIFY `tutor_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tutorial`
--
ALTER TABLE `tutorial`
  MODIFY `tutorial_id` int(10) NOT NULL AUTO_INCREMENT;
